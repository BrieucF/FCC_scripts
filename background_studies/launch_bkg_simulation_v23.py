...
reco_storage_path_global = os.path.join(input_file_path, "ddsimoutput_afterG4Fix")
...
for folder in os.listdir(input_file_path):
    ...
    command=f"ddsim --steeringFile /afs/cern.ch/user/b/brfranco/work/public/background_studies/FCC_scripts/background_studies/idea_steer.py --compactFile $K4GEO/FCCee/IDEA/compact/IDEA_o1_v03/IDEA_o1_v03.xml --inputFiles {input_filename} --outputFile {tmp_output_filename} -N -1 --crossingAngleBoost 0.015\n"
