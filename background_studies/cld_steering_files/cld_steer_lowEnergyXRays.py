...
SIM.inputFiles = glob.glob("/eos/experiment/fcc/users/b/brfranco/background_files/guineaPig_andrea_June2024_v23_vtx000/data96/pairs.pairs")
#SIM.inputFiles = ["/eos/experiment/fcc/users/b/brfranco/background_files/sr_photons_kevin/SR_photons_v5_cleaned/sr_photons_from_20Mpositron_45GeVcom_halo_v23_mediumfilter.hepevt"]
## Macro file to execute for runType 'run' or 'vis'
SIM.macroFile = ""
## number of events to simulate, used in batch mode
SIM.numberOfEvents = -1
## Outputfile from the simulation
#SIM.outputFile = "/eos/experiment/fcc/users/b/brfranco/background_files/low_energy_x_rays/CLD_sim_sr_photons_from_20Mpositron_45GeVcom_halo_v23_mediumfilter_lowEnergyXRays_withAuger.root"
SIM.outputFile = "CLD_sim_withoutAuger.root"
...
SIM.ui.commandsInitialize = ["/run/verbose 2"]
SIM.ui.commandsConfigure = ["/cuts/setLowEdge 50 eV", "/process/em/lowestElectronEnergy 1 eV", "/process/em/auger true" , "/process/em/deexcitationIgnoreCut true"]#, "/process/em/augerCascade true"] # no need to add the latter, already on
